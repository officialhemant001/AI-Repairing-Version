...
import { Mail, KeyRound, ArrowRight, Cpu } from 'lucide-react';
...
const Login = () => {
  ...
  const { login, loading, addToast } = useAppContext();
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">Log in to manage your device repair reports</p>
        </div>
