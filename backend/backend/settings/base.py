...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-default-change-in-production')
...
# ========================
# DATABASE (default SQLite, override in env-specific settings)
# ========================
DATABASES = {
    'default': {
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='AI Repair Vision <noreply@airepairvision.com>')
